...
// array from all the answer buttons
const answers = [...answerButtons]


// array from buttons which trigger the displayed <section> element to change
const nextSectionTriggers = [startBtn, ...nextBtns]


// Carray from all the <section> elements
const sections = [startSection, ...questionGroups, endSection]


// array from all question <li> elements in detailed results modal
const resultsQuestions = [ ...questionsInModal ]


// array from all stat <li> elements at the end of the game
const resultsStats = [ ...userStatsItems ]


// array from the questions.json object keys, which will help in selecting random questions
const questionsKeysArray = Object.keys(questions)


// array from the users.json object values
const usersValuesArray = Object.values(users)


// set which will store 10 random questions
const randomTen = new Set()


// set to store fake users
const gameUsers = new Set()


// variable to store current user's chosen username
let currentUser


// variable to store the user's running score
let runningScore = 0
